...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "Xiaonai's blog",

	// 站点 URL
	site_url: "https://blog.xiaonai.top",

	// 站点描述
	description:
		"Xiaonai的个人博客，记录生活点滴、技术心得和学习感悟。这里是一个分享知识、交流思想的平台，希望能为你带来有价值的内容和愉快的阅读体验。",
